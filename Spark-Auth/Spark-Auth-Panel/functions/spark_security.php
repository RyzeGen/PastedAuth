<?php
class spark_security{
    static function encrypt($str){
	return base64_encode(spark_security::caesar(base64_encode($str), 8));
    }
    static function decrypt($str){
	return base64_decode(spark_security::decaesar(base64_decode($str), 8));
    }
    ...
    static function decaesar($str, $n) {
        return spark_security::caesar($str, 26 - $n);
    }
